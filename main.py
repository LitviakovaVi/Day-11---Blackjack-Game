...
def blackjack():
  ...
  while not is_game_over:
    ...
    if computer_score == 0 or user_score == 0 or user_score > 21:
      ...
      draw = input("Would you like to draw another card? Type 'y' to continue, type 'n' to pass: ")
      if draw == "y":
        user_card.append(deal_card())
  ...
  def compare(user_score, computer_score):
    if user_score == computer_score:
      ...
      return "User loose. Computer win"
    else:
      return "Computer loose. User win"
...
blackjack()
restart = input("Would you like to restart the game? Type 'y' to restart, type 'n' to stop: ")
if restart == "y":
  clear()
  blackjack()
